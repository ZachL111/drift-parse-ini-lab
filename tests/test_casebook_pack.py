"""Regression checks for the drift-parse-ini-lab casebook."""
...
from casebook.harness import assert_expected, drift_parse_ini_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(drift_parse_ini_lab_summary(), assert_expected())
