...
`drift-parse-ini-lab` is centered on parsers work in Ruby. The technical target is: Implement a Ruby parsers project for ini event replay, using fixture event logs and golden state snapshots.
...
The score is deterministic. The current threshold is 161. Risk has a penalty of 6, latency has a penalty of 3, and weight contributes a bonus of 4.
